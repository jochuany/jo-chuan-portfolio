      ...
      <div className="flex w-screen h-auto pt-10 pb-10 justify-center items-start text-brand-text bg-brand-bg mt-[60px]">
        ...
        <div className="flex flex-col w-[90%] md:w-[80%] lg:w-[70%]">
          ...
          <div className="grid md:grid-cols-5 gap-8 mb-10">
            <div className="md:col-span-2">photo</div>

            <div className="md:col-span-3">
              <div className="flex font-bold mb-6 text-[16px]">
                ▌ABOUT ME
              </div>
              <div className="text-[16px] text-brand-text font-normal leading-8">
                我是一位具備設計、程式與研究背景的跨領域實踐者，擁有視覺設計、資訊動畫製作的經驗，也能進行 Next.js 前端實作；碩士期間的 XR 媒體心理學研究，則賦予我嚴謹的數據分析、邏輯論述與寫作能力。<br /><br />
                我亦擁有數位產品規劃與 UX 思維，能執行使用者研究、Flowchart、Wireframe 到 Prototype 的設計流程。跨領域背景使我能擔任研究、設計與開發之間的溝通橋樑，並能以技術實作的角度思考設計的可行性。期待未來能與跨團隊夥伴合作，共同優化數位世界的互動體驗！
              </div>
            </div>
          </div>

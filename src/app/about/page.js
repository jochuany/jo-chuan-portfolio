...
const exp = [
  {
    ...
    description: [
      "協助社會科學、媒體心理實驗法之研究進行，與助理群合作接待超過百位受試者，以確保數據品質，了解使用者在虛擬實境體驗中的心理行為。",
      "曾拍攝與剪輯 360 全景影片，並擁有 XR 頭戴式顯示器之操作經驗。",
      "協助沉浸科技、虛擬實境社交等主題之文獻搜集整理，掌握媒體心理學的研究趨勢。",
      "參與文化科技計畫：協助搜集國內外沉浸文化科技資料，包含各界定義、國內外成功案例等，並提出分類框架、根據產業架構整合臺灣文化科技產業地圖。",
      "參與數位信任計畫：協助專家訪談資料整理，進行數位信任之文獻探討，了解數位信任之定義、不同領域的數位信任、提升數位信任的方法等，並撰寫成報告。",
    ]
  },
  {

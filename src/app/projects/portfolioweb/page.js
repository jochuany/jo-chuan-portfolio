  ...
  details: [
    {
      ...
      description: "規劃網站架構、導航邏輯與頁面功能，包含在首頁設計精選作品區；固定導航列與電腦板固定側邊欄；在作品列表中規劃篩選功能；在作品內頁底部加上「Explore More」以提升使用者的留存率與瀏覽深度。"
    },
    {
      subtitle: "Next.js 前端開發：",
      description: "將設計稿轉化為具響應式設計的網頁。包含作品資訊模組化管理，提升後續擴充的可維護性與資料一致性；針對行動端設計旋轉裝置提示，確保視覺完整性；應用 React Bits 特效庫加入文字動畫。"
    },
  ],
  photos: [
